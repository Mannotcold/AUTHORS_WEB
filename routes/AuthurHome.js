...
const { postremovepage, getAuthurpage, geteditauthor, postupdateAuthor, getUpdatepaperpage, PaperSearchAuthur, postUpdatepage, getCreatePaper, postaddPaper } = require('../Controller/userController')
...
router.post('/PaperSearchAuthur/RemoveAuthor', verifyToken, verifyRole('admin'), postremovepage);
